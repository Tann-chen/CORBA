...
public abstract class CenterServerPOA extends org.omg.PortableServer.Servant
 implements DCMS.CenterServerOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // DCMS/CenterServer/createTRecord
       {
       ...
       case 1:  // DCMS/CenterServer/createSRecord
       {
         String managerId = in.read_string ();
         String firstName = in.read_string ();
         String lastName = in.read_string ();
       ...
       case 2:  // DCMS/CenterServer/getRecordCounts
       {
         String managerId = in.read_string ();
         String $result = null;
       ...
       case 3:  // DCMS/CenterServer/editRecord
       {
         String managerId = in.read_string ();
         String recordID = in.read_string ();
         String fieldName = in.read_string ();
         String newValue = in.read_string ();
         this.editRecord (managerId, recordID, fieldName, newValue);
         out = $rh.createReply();
         break;
       }

       case 4:  // DCMS/CenterServer/transferRecord
       {
         String managerId = in.read_string ();
         String recordID = in.read_string ();
         String remoteCenterServerName = in.read_string ();
         this.transferRecord (managerId, recordID, remoteCenterServerName);
         out = $rh.createReply();
         break;
       }
